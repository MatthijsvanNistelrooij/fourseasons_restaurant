...
const Footer = () => {
  ...
  return (
    ...
    >
      <div className="flex-col md:flex-row max-w-7xl mx-auto px-4 gap-12 md:py-24 mt-10 flex justify-between">
      ...
      <div className="flex justify-center">
        <p
          style={{ fontFamily: "var(--font-body)" }}
          className="text-sm text-[#f0f0f0] font-extralight flex justify-center w-64 md:w-full text-center mt-5 mb-10"
        >
