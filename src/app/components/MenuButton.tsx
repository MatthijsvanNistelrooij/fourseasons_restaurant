  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <button
          className="bg-[#f0f0f0] text-[#1a1a1a] text-sm md:text-base font-bold flex text-center justify-center w-fit px-5 md:px-8 py-2.5 md:py-3 hover:bg-gray-200 transition cursor-pointer"
